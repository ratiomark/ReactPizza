...
import PizzaItemInCart from "../components/pizzaItemInCart/PizzaItemInCart"
import CartEmpty from "../components/cartEmpty/CartEmpty"

const Cart = () => {
  const { totalItems, totalPrice, itemsInCart } = useSelector(state => state.cartSlice)
  const dispatch = useDispatch();

  if (Boolean(!totalItems)) return <CartEmpty />
  return (
    <>
      <div className="container container--cart">
        ...
        <div className="cart">
          ...
          <div className="content__items">
            {itemsInCart.map(pizzaData => <PizzaItemInCart {...pizzaData} key={pizzaData.idGenerated} />)}
